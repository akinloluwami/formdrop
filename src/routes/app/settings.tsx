                ...
                <div className="bg-white rounded-3xl border border-gray-200 p-6 md:p-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        <button className="px-4 py-2 bg-white border border-gray-200 rounded-3xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                          Change Avatar
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="pt-4 flex justify-end">
                      <button className="px-6 py-3 bg-accent text-white rounded-3xl font-medium hover:bg-accent/90 transition-colors shadow-lg shadow-accent/20">
                        Save Changes
                      </button>
                    </div>
                  </div>
              ...
              {activeTab === "billing" && (
                <div className="bg-white rounded-3xl border border-gray-200 p-6 md:p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="w-full py-3 border border-dashed border-gray-300 rounded-3xl text-sm font-medium text-gray-600 hover:bg-gray-50 hover:border-gray-400 transition-all flex items-center justify-center gap-2">
